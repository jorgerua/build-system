...
- [ ] 2. Atualizar docker-compose.yml com validação de variáveis
  - [ ] 2.1 Adicionar sintaxe ${VAR:?message} para variáveis obrigatórias
  - [ ] 2.2 Adicionar health checks para NATS
  - [ ] 2.3 Adicionar health checks para api-service
  - [ ] 2.4 Configurar depends_on com condition: service_healthy
